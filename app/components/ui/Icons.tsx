...
export function UserIcon({ className = "w-4 h-4", style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75}
...
export function UploadIcon({ className = "w-10 h-10", style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
export function PdfBadgeIcon({ className = "w-4 h-4", style }: IconProps) {
  return (
...
export function SparklesIcon({ className = "w-4 h-4", style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
